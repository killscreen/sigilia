...
public class ScenarioActivity extends FullscreenActivity implements CompletionCallback<Boolean> {
	...
	private void runScenario(Scenario s) {
		...
		engines.add(new InputEngine(Arrays.<InputElement>asList(new WeaponInput(new DefaultWeapon(), Arrays.<Weapon>asList(new LightningWeapon(), new FireWeapon()), touchInput, 0.05f))));
